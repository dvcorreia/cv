...
\begin{itemize}
  \item Designed and developed highly scalable and distributed services in \texttt{go} and \texttt{python} to connect and manage thousands of real-time location system (\textit{RTLS}) devices, based on bluetooth low energy (\textit{BLE}) and ultra-wideband (\textit{UWB}) technologies

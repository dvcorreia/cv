...
\tagline{\faKeyboard~Software Product Architect}
...
% \centerline{
%   Work at \emph{\href{https://www.wavecom.com/}{Wavecom Technologies}}
% }
\smallskip

\cvcompanyevent{\href{https://www.wavecom.com/}{Wavecom Technologies}}{Aveiro, Portugal}{
  \medskip

  \cvcompanyevententry{}{Product Technical Lead}{Dec 2022 -- Present}{Aveiro, Portugal}
  \begin{itemize}
    \item Owner of technical vision for WHEREIS v2
    \item Ensuring technical cohesion and quality over the lifecycle of the product 
  \end{itemize}

  \medskip

  \cvcompanyevententry{}{Software Product Architect}{May 2022 -- Dec 2022}{Aveiro, Portugal}
  \begin{itemize} 
    \item Working in the \href{https://en.wikipedia.org/wiki/Real-time_locating_system}{RTLS} standardization effort with the \href{https://omlox.com/}{Omlox™} consortium, part of the \href{https://www.profibus.com/technology/omlox}{\textit{Profibus \& Profinet International}}
    \item Lead a developer advocacy internal initiative to technically accelerate the company and promote innovation
  \end{itemize}

  \medskip

  \cvcompanyevententry{}{Software Engineer}{Apr 2021 -- May 2022}{Aveiro, Portugal}
  \begin{itemize}
    ...
    \item Maintain and modernize the company software life cycle tools and \textit{codebases} to improve development agility
  \end{itemize}
}
...
\cvevent{\href{https://www.ua.pt/en/curso/27}{Electronics and Telecom Engineering}}{Bachelor's \& Master's degrees}{}{Universidade de Aveiro, Portugal}
...
\cvevent{Exchange Student}{}{}{Politecnico di Torino, Italy}

Integrated the area of \textit{Information and Communication Technologies for Smart Societies}: focus on automotive, IoT applications, statistical learning and neural networks.
